...
class PostgreSQLMCP(Node):
    ...
    def execute(self, host: str, port: int = 5432, username: str = 'postgres', password: str = '', database: str = 'postgres', db_prompt: str = '', *args, **kwargs):
        try:
            ...
            postgresql_tool = PostgreSQLMCPTool(postgres_url=postgres_url, db_prompt=db_prompt)
