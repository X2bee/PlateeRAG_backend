...
class AgentVLLMNode(Node):
    ...
    parameters = [
        {"id": "model", "name": "Model", "type": "STR", "value": "", "required": False, "optional": True},
        {"id": "temperature", "name": "Temperature", "type": "FLOAT", "value": 0.0, "required": False, "optional": True, "min": 0.0, "max": 2.0, "step": 0.1},
        {"id": "max_tokens", "name": "Max Tokens", "type": "INTEGER", "value": None, "required": False, "optional": True, "min": 1, "max": 4000, "step": 1},
        {"id": "n_messages", "name": "Max Memory", "type": "INT", "value": 3, "min": 1, "max": 10, "step": 1, "optional": True},
        {"id": "base_url", "name": "Base URL", "type": "STRING", "value": "", "required": False, "optional": True},
    ]
    ...
    def execute(self, text: str, tools: Optional[Any] = None, memory: Optional[Any] = None,
                model: str = "", temperature: float = None, max_tokens: int = None, n_messages: int = 3, base_url: str = "") -> str:
        """
